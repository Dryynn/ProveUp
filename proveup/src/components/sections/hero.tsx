...
export function Hero(){
    return(
        <main className="mx-auto max-w-screen-xl px-2 flex flex-col md:flex-row py-10 md:py-5 items-center justify-center gap-5 md:gap-15 lg:gap-15">
            ...
            <div className=" flex flex-col gap-5 md:gap-9 justify-center text-center md:text-left">
                <h1 className="text-3xl md:text-5xl lg:text-7xl">Evoluir é só o <span className="text-proveup-orange">começo!</span></h1>
